...
const translations: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "onboarding.step4.desc": "每项AI操作消耗积分，免费用户赠送50积分。积分不足时联系管理员充值。",
    "onboarding.skip": "跳过",
    "onboarding.next": "下一步",
  ...
  en: {
    ...
    "onboarding.step4.desc": "Each AI operation costs credits. Free users get 50 credits. Contact admin to recharge when needed.",
